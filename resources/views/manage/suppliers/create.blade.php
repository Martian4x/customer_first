    ...
    <div class="breadcrumbs">
        <div class="container">
            ...
            <ul class="pull-right breadcrumb">
                ...
                <li><a href="/manage/lyrics">Lyrics</a></li>
                <li class="active">Add lyric</li>
            </ul>
        </div>
    </div><!--/breadcrumbs-->
    <!--=== End Breadcrumbs ===-->
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="panel panel-brown margin-bottom-40">
                    ...
                    {!! Form::open( array('route' =>'manage.lyrics.store','class'=>'form-horizontal sky-form', 'role'=>'form', 'files'=>true)) !!}
                    @include('manage.lyrics._form')
