...
class CustomersController extends Controller
{
    ...
    public function create()
    {
      ...
      $vars['title'] = 'User';
      $vars['sub_title'] = 'Add a customer';
      return view('manage.customers.create', compact('vars'));
    }
	...
	public function store(Request $request){
      ...
      $wecome_msg= $supplier->getMsg('welcome', $customer->lang);
      if($wecome_msg&&$input['send_sms']==true){
         $customer->send_sms($wecome_msg->body);
      }

		return Redirect::back()->withMessage($customer->fname.' '.$customer->lname.' is registered successful')->with('flash_type', 'success');
	}
